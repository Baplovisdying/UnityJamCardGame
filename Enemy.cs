...
public class Enemy : MonoBehaviour, IDoEffect, IEnemy
{
    ...
    {
        m_HP--;
        cameraController.StartCameraShake(0.06f);
    ...
    {
        m_HP -= 2;
        cameraController.StartCameraShake(0.07f);
    ...
    void HandleKonckBack()
    {
        ...
        StartCoroutine(TimeController(0.1f));
    }
    ...
    void HandleGetClose()
    {
        ...
        cameraController.StartCameraShake(0.10f);
        hitEffect.Play("EnemyHitEffect_3");
